...
def runScript(test_file, pyop2_out, out_file, level, mesh_f, mesh_s):
    ...
    f.close()
    subprocess.call(['python3', '/home/clara/GMGGPU-Evaluation/parse_pyop2.py', pyop2_out, out_file])
...
def runNvp(test_no, test_file, nvp_out, out_file, level, mesh_f, mesh_s, counter):
    ...
    subprocess.call(['python3', '/home/clara/GMGGPU-Evaluation/parse_nvprof.py', str(test_no), level, counter, mesh_f, mesh_s, nvp_out, out_file])
...
def runNvc(output_file, out_file, level, mesh_f, mesh_s, counter):
    ...
    with open(output_file, 'w') as fi:
        subprocess.call(['nv-nsight-cu-cli', '--metrics'] + metrics + ['python3', '/home/clara/GMGGPU-Evaluation/test_w_args.py'], stdout=fi)
    subprocess.call(['python3', '/home/clara/GMGGPU-Evaluation/parse_nvprof.py', str(4), level, counter, mesh_f, mesh_s, output_file, out_file])
...
#runNvpTest("/home/clara/GMGGPU-Evaluation/results/harder_solver/", "harder_solver.py")
#runNvpTest("/home/clara/GMGGPU-Evaluation/results/3D/", "3D.py")
#runNvpTest("/home/clara/GMGGPU-Evaluation/results/diff_meshes/", "diff_meshes.py")
